    ...
    return(
        <div className="max-w-screen-lg mx-auto py-28 flex flex-col md:flex-col gap-1 font-serif px-10">
            <div className="flex gap-1">
                ...
                <div className="bg-zinc-800 rounded-md flex flex-col justify-between w-full h-[480px] md:w-2/3 mb-4">
                    <img className=""src={img} alt="md"/>
                    <Button className="mb-6" name="On Medium" link="https://medium.com/@ksknew76"/>
                </div>
            </div>
